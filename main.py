...
video_capture = cv2.VideoCapture(0) # this number can be anything according to our camera or web cam
...
person2_image = face_recognition.load_image_file("faces/person2.png")
...
while True:
    ...
    small_frame = cv2.resize(frame, (0,0), fx=0.25, fy=0.24)
